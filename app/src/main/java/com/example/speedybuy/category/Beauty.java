...
public class Beauty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_beauty);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });
        recyclerview_beauty = findViewById(R.id.recyclerview_beauty);
        lottieAnimationView = findViewById(R.id.animationView_beauty);
        getData();
    ...
    private void getData() {
        ...
        itemsRef.child("beauty").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Item_list_recy_adapter ad = new Item_list_recy_adapter(Beauty.this, item_array, "Beauty");
                recyclerview_beauty.setLayoutManager(new GridLayoutManager(Beauty.this, 2));
                recyclerview_beauty.setAdapter(ad);
            }
            @Override
